...
export VLOG="questa-2023.4 vlog"
...
export SN_LLVM_BINROOT=/usr/scratch2/vulcano/colluca/tools/riscv32-snitch-llvm-almalinux8-15.0.0-snitch-0.2.0/bin # ToDo(cdurrer): update path?
